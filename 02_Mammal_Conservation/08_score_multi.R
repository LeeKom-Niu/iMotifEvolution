...
# Purpose: Associate iMotif stability scores with group information, compare score distributions across groups (C1, C2, C3, Other)
# Plot types: boxplot, violin+boxplot, boxplot+jitter (all three generated)
# Significance markers: original script style, three comparison groups share same y-axis height (may overlap)
# OUP compliant - font >=7pt, line width 0.25-1pt, colorblind-friendly palette
...
if (any(is.na(combined$score))) {
  warning("Some iMotifs not found in stability file; these rows will be filtered.")
