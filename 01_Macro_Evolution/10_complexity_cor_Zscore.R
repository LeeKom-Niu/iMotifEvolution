# ============================================================
# Script 1: i-Motif Z-score partial correlation analysis (main analysis)
# Output directory: ./results_zscore/
# Three panels: no control → dual control → triple control
# Modified: output both PDF + PNG formats
# ============================================================
...
if (nrow(df_clean) == 0) stop("No rows left after cleaning! Check column names.")
...
cat(sprintf("Simple correlation rho = %.3f, P = %s\n", cor_simple$estimate,
...
cat(sprintf("Partial correlation (controlling Size+Density) rho = %.3f, P = %s\n",
...
cat(sprintf("Partial correlation (controlling Size+Density+GC) rho = %.3f, P = %s\n",
...
# ---- Unified save function: output both PDF + PNG ----
...
cat("Figure 1 (no control) saved as PDF + PNG\n")
...
cat("Figure 2 (dual control) saved as PDF + PNG\n")
...
cat("Figure 3 (triple control) saved as PDF + PNG\n")
...
cat("Figure 4 (boxplot) saved as PDF + PNG\n")
...
cat("Figure 5 (faceted regression) saved as PDF + PNG\n")
